    ...
    return (
      <div className="p-8   bg-[#8D1A5F] flex items center gap-4 justify-between ">
        <div className="w-1/2 flex flex-col justify-center p-10">
          <h1 className="text-3xl text-white tracking-wide font-bold p-2 ">
            Readily available AI tool for you.
          </h1>
          <p className="text-lg tracking-wide p-2 mb-8 ">
            Explore variety of AI tools that are ready for use. Using AI tools
            is one of the best way to kick start your business.
          </p>

          <Button name={"Explore "} action={toTools} />
        </div>
